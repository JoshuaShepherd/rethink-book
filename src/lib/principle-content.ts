...
export const principleContent: Record<string, { title: string; content: string; hasContent: boolean }> = {
  'incarnational-mission': {
    ...
    hasContent: true,
    content: `# Rethink Incarnational Mission
...
48`,
  ...
  'rethink-scorecards': {
    ...
    hasContent: true,
    content: `Conclusion: Think Long Haul, Not Quick Fix 
05
08
12
17
