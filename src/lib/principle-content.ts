// Auto-generated from MDX files in content/principles/
...
of the church, mission, and church planting.`,
  ...
  'principle-1': {
    ...
    hasContent: true,
    content: `# PRINCIPLE 1: RETHINK THE MISSIONARY NATURE OF GOD
...
> from our understanding of Jesus’ mission as revealed in the Gospels.`,
  ...
  'principle-10': {
    ...
    hasContent: true,
    content: `# PRINCIPLE 10: RETHINK STRATEGIES AND MODELS
...
that God has put on your life for a particular place and people group.`,
  ...
  'principle-11': {
    ...
    hasContent: true,
    content: `# PRINCIPLE 11: RETHINK FLOW
...
toward church.
# C U LT I VAT I N G C O M M U N I T Y
...
# S P I R I T U A L M O M E N T U M
...
# S T R U C T U R I N G C O N G R E G AT I O N
...
mission and is formed for mission.`,
  ...
  'principle-12': {
    ...
    hasContent: true,
    content: `# PRINCIPLE 12: RETHINK SCORECARDS
...
the church`,
  ...
  'principle-2': {
    ...
    hasContent: true,
    content: `# PRINCIPLE 2: RETHINK THE MISSIONARY NATURE OF THE CHURCH
...
# R E F O R M AT I O N H E R I TA G E V I E W
People today understand the church in two prominent ways. The first
view is what some call the “Reformation heritage” perspective.2 The
...
# C O N T E M P O R A R Y VA R I AT I O N V I E W
...
the nations.`,
  ...
  'principle-4': {
    ...
    hasContent: true,
    content: `# PRINCIPLE 4: RETHINK MISSIO DEI
...
‘undertakes’ mission; it is the **missio Dei** which constitutes the church.”8
...
## G O D ’ S M I S S I O N A S T H E O R G A N I Z I N G
# P R I N C I P L E
...
mission.”9 However, when the church begins to define itself as an
...
nor make a **missional** church.10
...
# G O D ’ S M I S S I O N A S T H E
...
rather than mission alone.12
# F O U R S T E P S T O WA R D
# M I S S I O N A L E N G A G E M E N T
...
working in that place long before we ever arrived.`,
  ...
  'principle-5': {
    ...
    hasContent: true,
    content: `# PRINCIPLE 5: POST-Christendom
...
in the early church.`,
  ...
  'principle-6': {
    ...
    hasContent: true,
    content: `# PRINCIPLE 6: RETHINK PLACE
...
begin with our tangible presence in the place where God has called us.`,
  ...
  'principle-8': {
    ...
    hasContent: true,
    content: `# PRINCIPLE 8: RETHINK multiplication
...
you won’t see **multiplication** movement.`,
  ...
  'principle-9': {
    ...
    hasContent: true,
    content: `# PRINCIPLE 9: RETHINK TEAMS
